...
\JL{Ja bym napisał: że dla wiekszosci indeksow Jaccarda ważona ma nieco mniejsze obciążenie i podobną wariancję.
Nie za bardzo wiem co to jest tendencja...}
...
\JL{Gdzie jest napisane ile eksperymentów przypada na jeden punkt  na wykresie?
Jak nie ma to by się przydało napisać.}
\begin{figure}[h!]
