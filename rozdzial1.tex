...
Powyższy szkic możemy w naturalny sposób wykorzystać do wyznaczenia wartości  estymatora \texttt{Linear Counting} potrzebnego do zastosowania korekcji $1.$ Zauważmy, że szkic, dla którego parametr $q = 0$ 
