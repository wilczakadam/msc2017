...
%Na wykresie \ref{fig:mincount_hist} zamieszczamy histogram prezentujący rozkład błędu względnego tego algorytmu dla ok. $10^5$ eksperymentów, z parametrem $k=100$. 
...
\begin{figure}[h!]
	\includegraphics[width=0.6\textwidth]{HLLErrHist.png}
	\centering
