...
\AW{dodac histogram i napisac ze pokrywa sie z rozkladem normalnym}
...
\begin{enumerate}
    ...
    \end{equation}
    \AW{do uzupełnienia jeszcze wyjasnienie skad wzor}
\end{enumerate}
