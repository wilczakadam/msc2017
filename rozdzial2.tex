...
\JL{Ja bym zostawił, ale napisał ze w nastepnym rozdziale zajmiemy sie tym dokladniej.}
...
%\JL{Tutaj zdanie wyjasnienia z czego wynika odejmowanie tej alfy}       
       ...
       \AW{nie wiem czy dobrze przetłumaczyłem? "converges in probability"}
       \JL{To sie chyba tlumaczy jako ''zbiega według prawdopodobienstwa''}
