...
\AW{Czy tutaj konieczne jest pokazanie tego wzoru? Bo w nastepnym podrozdziale on znowu się pojawia i tam jest omówiony troche dokladniej}
...
\AW{Czy takie wyjasnienie będzie OK?}
...
\AW{Czy takie wyjasnienie wystaczy?}
...
%\JL{Tutaj zdanie wyjasnienia z czego wynika odejmowanie tej alfy}       
       ...
       Estymator wyprowadzony tą metodą ma szereg istotnych własności. Wraz ze wzrostem rozmiary próby jest asymptotycznie nieobciążony, asymptotycznie najefektywniejszy, ma asymptotycznie rozkład normalny, a także jest zgodny. Estymator $T_n$ parametru $\theta$ nazywamy \textit{zgodnym} jeśli jest \textit{zbieżny w prawdopodobieństwie} \AW{nie wiem czy dobrze przetłumaczyłem? "converges in probability"} do prawdziwej wartości parametru, czyli inaczej mówiąc - jeśli spełniona jest równość:
       \begin{equation}
